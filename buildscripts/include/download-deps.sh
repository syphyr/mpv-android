...
if [ ! -d python ]; then
	...
	python3 ../../include/py/uncomment.py Modules/Setup \
		'readline|_test|spwd|grp|_crypt|nis|termios|resource|audio|_md5|_sha[1235]|_tkinter|syslog|_curses|_g?dbm|_(multibyte)?codec|_hashlib|_ssl|_bz2|_ctypes|_lzma|_uuid|zlib|_posixshmem'
